...
export default function SuperAdminUsersPage() {
  ...
  const fetchUsers = async () => {
    setLoading(true);
    try {
      const res = await fetch('/api/super-admin/users', { credentials: 'include', cache: 'no-store' });
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <main className="p-6 max-w-7xl mx-auto pb-12">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500">Super admin credential management</p>
          </div>
